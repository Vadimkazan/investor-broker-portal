...
const SYSTEM_PROMPT = `Ты — ИИ-консультант платформы InvestPro, помогаешь всем посетителям сайта: инвесторам, брокерам и гостям.

О платформе InvestPro:
...
- Если вопрос не связан с платформой или инвестициями в недвижимость — вежливо скажи, что специализируешься на вопросах о платформе InvestPro и инвестициях в недвижимость.
        ...
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 w-[calc(100vw-2rem)] sm:w-96 max-w-96 h-[min(600px,calc(100vh-3rem))] bg-background border rounded-xl shadow-2xl flex flex-col overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b bg-primary text-primary-foreground">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm">ИИ-консультант InvestPro</span>
            </div>
            <button
              type="button"
